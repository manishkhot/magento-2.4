 ...
 */
namespace Lof\StoreLocator\Block\StoreLocator;

use Magento\Framework\View\Element\Template\Context;
use Lof\StoreLocator\Helper\Data;
...
class Index extends \Magento\Framework\View\Element\Template
{
    ...
    public function getListCollection() {
        if(!isset($this->_listStoreLocations)){
            $_data = $this->_storelocatorCollection->create();
            $orderby = "ASC";
            $_data->getSelect()->order("main_table.position " . $orderby);
            $this->_listStoreLocations = $_data->getData();
        }
        return $this->_listStoreLocations;
    }

    public function getCountry(){
        $_locationData = $this->getListCollection();
        $_resultData = array();
