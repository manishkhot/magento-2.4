 ...
 */
namespace Lof\StoreLocator\Block\Adminhtml\Tag\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Lof\StoreLocator\Model\ResourceModel\Tag\Collection
     */
    ...
    public function __construct(
        ...
        \Lof\StoreLocator\Model\ResourceModel\Tag\Collection $storelocatorCollection,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
         ...
         */
        if ($this->_isAllowedAction('Lof_StoreLocator::tag_save')) {
        ...
        $this->_eventManager->dispatch('adminhtml_storelocator_tag_edit_tab_main_prepare_form', ['form' => $form]);
    ...
    public function getCatCollection(){
        ...
        $collection = $this->_categoryCollection
            ->addFieldToFilter('tag_id', array('neq' => $model->getId()));
        return $collection;
    }
