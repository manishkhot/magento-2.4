 ...
 */
namespace Lof\StoreLocator\Block\Adminhtml;
        ...
        if ($this->items === null) {
            $items = [
                'storelocator' => [
                    ...
                    'resource' => 'Lof_StoreLocator::storelocator',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Store'),
                            'url'      => $this->getUrl('*/storelocator/new'),
                            'resource' => 'Lof_StoreLocator::storelocator_edit',
                           ]
                       ]
                ],
                'category' => [
                    ...
                    'resource' => 'Lof_StoreLocator::category',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Category'),
                            'url'      => $this->getUrl('*/category/new'),
                            'resource' => 'Lof_StoreLocator::category_edit',
                           ]
                       ]
                ],
                'tag' => [
                    ...
                    'resource' => 'Lof_StoreLocator::tag',
                    'child'    => [
                        'newAction' => [
                            'title'    => __('New Tag'),
                            'url'      => $this->getUrl('*/tag/new'),
                            'resource' => 'Lof_StoreLocator::tag_edit',
                           ]
                       ]
                ],
                'system_config' => [
                    ...
                    'resource' => 'Lof_StoreLocator::config_storelocator'
                ],
                'readme' => [
                    'title' => __('Guide'),
