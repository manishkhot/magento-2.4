...
namespace Lof\StoreLocator\Block\Adminhtml\StoreLocator;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lof_StoreLocator::storelocator_delete')) {
    ...
    protected function _prepareLayout()
    {
        $this->_formScripts[] = '
            ...
            require([
                "jquery",
                "Lof_StoreLocator/js/jquery.minicolors.min"],function($){
