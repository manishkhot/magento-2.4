...
class Gmap extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    public function __construct(
        ...
        \Lof\StoreLocator\Model\ResourceModel\StoreLocator\CollectionFactory $storelocatorCollection,
        \Magento\Directory\Model\Config\Source\Country $countryFactory,
        \Magento\Directory\Model\Config\Source\Allregion $regionFactory,
        \Lof\StoreLocator\Model\ResourceModel\Tag\CollectionFactory $tagCollection,
        \Lof\StoreLocator\Model\ResourceModel\Category\CollectionFactory $categoryCollection,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
         ...
         */
        if ($this->_isAllowedAction('Lof_StoreLocator::storelocator_save')) {
       ...
       if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        $fieldset->addType('gmap','Lof\StoreLocator\Block\Adminhtml\StoreLocator\Edit\Tab\Form\Field\Gmap');
        $fieldset->addField(
            'gmap',
            'gmap',
            [
