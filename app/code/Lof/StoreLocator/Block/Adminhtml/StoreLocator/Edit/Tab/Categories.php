...
class Categories extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Lof\StoreLocator\Model\Category $categoryFactory,
        array $data = []
        ) {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Action'),
                'type' => 'action',
                'renderer'  => 'Lof\StoreLocator\Block\Adminhtml\Category\Renderer\CategoryAction',
                'filter' => false,
            ]
            );
        // $this->addColumn(
    ...
    public function getSelectedCategories()
    {
        ...
        if ($id) {
            ...
            if (!is_array($category)){
                $modelCategory = $objectManager->create('Lof\StoreLocator\Model\Category');
                $_categoryValue = $modelCategory->selectNameIN($category);
