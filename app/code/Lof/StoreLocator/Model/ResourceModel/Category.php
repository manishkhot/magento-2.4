...
class Category extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('lof_storelocator_storelocator_category', 'category_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('lof_storelocator_storelocator_category'), $condition);
    ...
    protected function _afterLoad(\Magento\Framework\Model\AbstractModel $object)
    {
        if ($id = $object->getId()) {
            ...
            ->from($this->getTable('lof_storelocator_storelocator_category'))
            ->where(
                'category_id = '.(int)$id
                );
