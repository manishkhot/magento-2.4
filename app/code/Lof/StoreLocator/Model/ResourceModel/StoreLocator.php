 ...
 */
namespace Lof\StoreLocator\Model\ResourceModel;
...
class StoreLocator extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('lof_storelocator_storelocator', 'storelocator_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('lof_storelocator_storelocator'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        if($stores = $object->getStores()){
            $table = $this->getTable('lof_storelocator_storelocator_store');
    ...
    protected function _afterLoad(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        if ($id = $object->getId()) {
            ...
            ->from($this->getTable('lof_storelocator_storelocator'))
            ->where(
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                ['cbs' => $this->getTable('lof_storelocator_storelocator_store')],
    ...
    public function lookupStoreIds($id)
    {
        ...
        $select = $connection->select()->from(
            $this->getTable('lof_storelocator_storelocator_store'),
            'store_id'
            )->where(
