 ...
 */
namespace Lof\StoreLocator\Model\ResourceModel\StoreLocator;
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->performAfterLoad('lof_storelocator_storelocator_store', 'storelocator_id');
    ...
    {
        $this->_init('Lof\StoreLocator\Model\StoreLocator', 'Lof\StoreLocator\Model\ResourceModel\StoreLocator');
    ...
    {
        $this->joinStoreRelationTable('lof_storelocator_storelocator_store', 'storelocator_id');
    }
