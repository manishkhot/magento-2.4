 ...
 */
namespace Lof\StoreLocator\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const MENU_URL_PATH_EDIT = 'storelocator/category/edit';
    const MENU_URL_PATH_DELETE = 'storelocator/category/delete';
