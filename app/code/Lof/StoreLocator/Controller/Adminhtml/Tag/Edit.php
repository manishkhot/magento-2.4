 ...
 */
namespace Lof\StoreLocator\Controller\Adminhtml\Tag;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Lof_StoreLocator::tag_edit');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Lof_StoreLocator::tag_manage')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Lof\StoreLocator\Model\Tag');
