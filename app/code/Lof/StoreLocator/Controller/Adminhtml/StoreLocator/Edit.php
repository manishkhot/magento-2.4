...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Lof_StoreLocator::storelocator_edit');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Lof_StoreLocator::storelocator_storelocator')
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getName() : __('New StoreLocator'));
