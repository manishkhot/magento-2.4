...
use BelVG\GuestWishlist\Model\Item\Option;
use BelVG\GuestWishlist\Model\Item\OptionFactory;
use BelVG\GuestWishlist\Model\ResourceModel\Item\Option\CollectionFactory;
...
class Item extends AbstractModel implements ItemInterface
{
    ...
    public function __construct(
        ...
        $this->serializer = $serializer ? $serializer : \Magento\Framework\App\ObjectManager::getInstance()
            ->create(\BelVG\GuestWishlist\Model\SerializerBridge::class);
    ...
    {
        $this->_init(\BelVG\GuestWishlist\Model\ResourceModel\Item::class);
    }
