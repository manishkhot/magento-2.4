 ...
 */
namespace BelVG\GuestWishlist\Model\ResourceModel\Item;
...
/**
 * Class Collection
 * @package BelVG\GuestWishlist\Model\ResourceModel\Item
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    /**
     * @var \BelVG\GuestWishlist\Model\ResourceModel\Item\Option\CollectionFactory
     */
     ...
     * @param \BelVG\GuestWishlist\Model\ResourceModel\Item $resource
    ...
    public function __construct(
        ...
        \BelVG\GuestWishlist\Model\ResourceModel\Item\Option\CollectionFactory $optionCollectionFactory,
        \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory,
        \Magento\Catalog\Model\ResourceModel\ConfigFactory $catalogConfFactory,
        \Magento\Catalog\Model\Entity\AttributeFactory $catalogAttrFactory,
        \BelVG\GuestWishlist\Model\ResourceModel\Item $resource,
    ...
    {
        $this->_init(\BelVG\GuestWishlist\Model\Item::class, \BelVG\GuestWishlist\Model\ResourceModel\Item::class);
    ...
    protected function _assignOptions()
    {
        ...
        /* @var $optionCollection \BelVG\GuestWishlist\Model\ResourceModel\Item\Option\Collection */
        $optionCollection = $this->_optionCollectionFactory->create();
        $optionCollection->addItemFilter($itemIds);

        /* @var $item \BelVG\GuestWishlist\Model\Item */
    ...
    protected function _assignProducts()
    {
        \Magento\Framework\Profiler::start(
            'GUESTWISHLIST:' . __METHOD__,
            ['group' => 'GUESTWISHLIST', 'method' => __METHOD__]
        );
        ...
        $this->_eventManager->dispatch(
            'guestwishlist_item_collection_products_after_load',
        ...
        \Magento\Framework\Profiler::stop('GUESTWISHLIST:' . __METHOD__);
     ...
     *
     * @param \BelVG\GuestWishlist\Model\Wishlist $wishlist
     * @return $this
     */
    public function addWishlistFilter(\BelVG\GuestWishlist\Model\Wishlist $wishlist)
    {
     ...
     * @return $this
     */
    public function addGuestCustomerIdFilter($customerId)
    {
        $this->getSelect()->join(
