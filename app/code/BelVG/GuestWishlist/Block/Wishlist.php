 ...
 */
namespace BelVG\GuestWishlist\Block;

/**
 * Class Wishlist
 * @package BelVG\GuestWishlist\Block
 */
class Wishlist extends \Magento\Wishlist\Block\AbstractBlock
{
    ...
    /**
     * @param \BelVG\GuestWishlist\Model\Item $item
     * @return string
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function getDetailsHtml(\BelVG\GuestWishlist\Model\Item $item)
    {
